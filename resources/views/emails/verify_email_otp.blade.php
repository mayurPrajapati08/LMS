...
<body style="margin:0;padding:0;background:#eef4ff;font-family:Arial,sans-serif;color:#172033;">
    @php
        ...
        <div style="max-width:640px;margin:0 auto;">
            ...
            <div style="background:#ffffff;border-radius:28px;overflow:hidden;box-shadow:0 24px 60px rgba(7,21,43,0.22);">
                    ...
                    <table role="presentation" style="width:100%;border-collapse:collapse;">
                        <tr>
                            <td style="vertical-align:top;">
                                <div style="display:inline-block;padding:10px 14px;border-radius:999px;background:rgba(255,255,255,0.14);color:#dbeafe;font-size:12px;font-weight:700;letter-spacing:.14em;text-transform:uppercase;">
                                    No-Reply Mail
                                </div>
                                <p style="margin:18px 0 0;color:#e0f2fe;font-size:15px;line-height:1.7;">
                                    {{ $intro }}
                                </p>
                            </td>
                        </tr>
                ...
                <div style="padding:34px 32px 22px;">
                    <div style="margin:0 0 14px;color:#5a6780;font-size:13px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;">
                        {{ $otpLabel }}
                    </div>

                    <div style="margin:0 0 26px;padding:22px 20px;border-radius:22px;background:linear-gradient(135deg,#eff6ff 0%,#dbeafe 100%);border:1px solid #bfdbfe;text-align:center;">
                        <span style="display:inline-block;font-size:38px;line-height:1;letter-spacing:.32em;font-weight:800;color:#0f172a;">{{ $otp }}</span>
                    </div>
                    ...
                    <table role="presentation" style="width:100%;border-collapse:separate;border-spacing:0 12px;">
                        <tr>
                            <td style="width:42px;vertical-align:top;">
                                <div style="width:42px;height:42px;border-radius:14px;background:#e0ecff;text-align:center;line-height:42px;font-size:20px;">1</div>
                            </td>
                            <td style="padding-left:14px;color:#41506a;font-size:15px;line-height:1.7;">
                                Enter this {{ strtolower($otpLabel) }} on the verification screen in your browser.
                            </td>
                        </tr>
                        <tr>
                            <td style="width:42px;vertical-align:top;">
                                <div style="width:42px;height:42px;border-radius:14px;background:#e6fff1;text-align:center;line-height:42px;font-size:20px;">2</div>
                            </td>
                            <td style="padding-left:14px;color:#41506a;font-size:15px;line-height:1.7;">
                                This {{ strtolower($otpLabel) }} expires in <strong style="color:#0f172a;">10 minutes</strong>.
                            </td>
                        </tr>
                        <tr>
                            <td style="width:42px;vertical-align:top;">
                                <div style="width:42px;height:42px;border-radius:14px;background:#fff4e5;text-align:center;line-height:42px;font-size:20px;">3</div>
                            </td>
                            <td style="padding-left:14px;color:#41506a;font-size:15px;line-height:1.7;">
                                {{ $finalNote }}
                            </td>
