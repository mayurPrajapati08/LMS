            ...
            <div class="w-full max-w-md">
                ...
                @unless ($isOtpVerification)
                    ...
                    <div class="space-y-4 mb-8">
                        <button class="w-full flex items-center justify-center gap-3 bg-surface-container-lowest border border-outline-variant py-3 px-4 rounded-xl font-semibold text-on-surface hover:bg-surface-container transition-colors active:scale-[0.98] duration-200">
