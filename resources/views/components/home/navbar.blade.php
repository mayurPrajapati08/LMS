    ...
    $collegeStudentMenu = [
        [
            ...
            'items' => [
                [
                    'provider' => 'CodeInYourself',
                    'provider_subtitle' => 'Career path programs',
                    'title' => 'Training Programs for College Students',
                    'description' => 'Explore structured training paths built for internships, projects, and placement preparation.',
        ...
        [
            ...
            'items' => [
                [
                    'provider' => 'CodeInYourself',
                    'provider_subtitle' => 'Hands-on sessions',
                    'title' => 'College Student Workshops',
                    'description' => 'Join practical workshops for fast skill-building, guided practice, and project-focused learning.',
                    'href' => $workshopUrl,
                    'icon' => 'event',
                    'badge' => 'Live',
                ],
        ...
        [
            ...
            'items' => [
                [
                    'provider' => 'CodeInYourself',
                    'provider_subtitle' => 'Guidance and planning',
                    'title' => 'Book a Free Mentorship Session',
                    'description' => 'Get one-to-one guidance on learning path, projects, and placement readiness as a college student.',
