...
<button id="adminSidebarToggle" type="button" class="md:hidden fixed top-2.5 left-3 z-[70] w-10 h-10 rounded-xl border border-[#d5e4ff] bg-white text-[#0c4ea3] flex items-center justify-center shadow-sm transition-opacity duration-200" aria-label="Open admin menu" onclick="toggleAdminSidebar(true)">
...
<!-- SideNavBar Anchor -->
<aside id="adminSidebar" class="h-[100dvh] w-64 fixed left-0 top-0 overflow-y-auto bg-[linear-gradient(180deg,#f5faff_0%,#eef5ff_100%)] flex flex-col py-6 px-4 pb-[calc(1.5rem+env(safe-area-inset-bottom))] z-50 transform -translate-x-full md:translate-x-0 transition-transform duration-300 border-r border-[#dbe8ff]">
    <div class="mb-10 px-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="text-[1.05rem] font-extrabold tracking-[-0.03em] text-[#08275c]">CodeInYourself</h1>
                <p class="text-[10px] font-bold uppercase tracking-[0.2em] text-[#1570d8] mt-1">Admin Panel</p>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-1 space-y-1">
        <a href="/admin/dashboard" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            ...
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isDashboard,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isDashboard,
        ])>
        ...
        <a href="/admin/categories" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isCategories,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isCategories,
        ])>
        ...
        <a href="/admin/courses" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isCourses,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isCourses,
        ])>
        ...
        <a href="/admin/users" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isUsers,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isUsers,
        ])>
        ...
        <a href="/admin/instructors" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isInstructors,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isInstructors,
        ])>
        ...
        <a href="/admin/payments" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isPayments,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isPayments,
        ])>
        ...
        <a href="/admin/analytics" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isAnalytics,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isAnalytics,
        ])>
        ...
        <a href="/admin/reviews" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isReviews,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isReviews,
        ])>
        ...
        <a href="/admin/support" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isSupport,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isSupport,
        ])>
        ...
        <a href="/admin/settings" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
            'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
            'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isSettings,
            'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isSettings,
        ])>
        ...
        @if ($isSuperAdmin)
            <a href="/admin/admins" onclick="if (window.innerWidth < 768) toggleAdminSidebar(false)" @class([
                'flex items-center gap-3 px-4 py-3 rounded-lg active:scale-[0.98] duration-150',
                'text-[#0b3f88] dark:text-[#76c6ff] font-semibold bg-white dark:bg-slate-800 shadow-sm' => $isAdmins,
                'text-slate-500 dark:text-slate-400 hover:text-[#0c4ea3] dark:hover:text-[#76c6ff] transition-colors hover:bg-slate-200/50 dark:hover:bg-slate-800/50' => !$isAdmins,
            ])>
        ...
        <div class="mt-auto rounded-2xl border border-[#d7e6ff] bg-white/80 px-4 py-4 shadow-[0_10px_24px_rgba(7,32,84,0.08)]">
        <div class="flex items-center gap-3">
            @if ($user?->avatar_path)
