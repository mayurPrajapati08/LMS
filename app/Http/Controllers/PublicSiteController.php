...
class PublicSiteController extends Controller
{
    ...
    public function sitemap(): Response
    {
        $routes = [
            ...
            ['name' => 'home.courses', 'changefreq' => 'daily', 'priority' => '0.9'],
            ['name' => 'home.career-paths', 'changefreq' => 'weekly', 'priority' => '0.9'],
            ['name' => 'home.corporate-training', 'changefreq' => 'weekly', 'priority' => '0.8'],
            ['name' => 'home.free_workshop', 'changefreq' => 'weekly', 'priority' => '0.8'],
            ['name' => 'home.mentorship', 'changefreq' => 'weekly', 'priority' => '0.8'],
            ['name' => 'home.placement', 'changefreq' => 'weekly', 'priority' => '0.8'],
            ['name' => 'home.about', 'changefreq' => 'monthly', 'priority' => '0.7'],
            ['name' => 'home.contact', 'changefreq' => 'monthly', 'priority' => '0.6'],
            ['name' => 'home.career-with-us', 'changefreq' => 'weekly', 'priority' => '0.6'],
        ];
    ...
    private function careerPathLibrary(): array
    {
        return [
            $this->buildCareerPath([
                ...
                'duration' => '7 Months',
                'price' => 120000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103689/dscience_xyh7bd.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '4 Months',
                'price' => 60000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103728/data_analytics_ao0pqb.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '3 Months',
                'price' => 40000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103506/sql_eja2mr.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '6 Months',
                'price' => 60000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103597/cc_jkbjy4.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '6 Months',
                'price' => 60000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103647/cy_bifejx.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '7 Months',
                'price' => 120000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103860/adm_fwmyuv.jpg",
             ...
             $this->buildCareerPath([
                ...
                'duration' => '3 Months',
                'price' => 35000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103940/power_bi_rqpzjk.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '2 Months',
                'price' => 20000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103973/gai_uzabu1.jpg",
            ...
            $this->buildCareerPath([
                ...
                'price' => 120000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103556/fwd_sld03l.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '6 Months',
                'price' => 70000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103786/mad_izxubc.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '6 Months',
                'price' => 70000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103812/web_dev_uzkmo2.jpg",
            ...
            $this->buildCareerPath([
                ...
                'duration' => '4 Months',
                'price' => 50000,
                'thumbnail' => "https://res.cloudinary.com/dqxg5hhfi/image/upload/v1777103897/gd_ocgpoc.jpg",
